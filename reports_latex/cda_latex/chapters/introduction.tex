...
provides an optimal environment for analyzing "affinity networks" \cite{affin}, where community formation is driven by taste homophily
...
A key focus of our investigation is the evaluation of topological agents. We test the hypothesis that standard Random Walker models \cite{walker},
...
\begin{itemize}
    ...
    using dynamic community detection?
