...
In this section\footnote{The complete experimental pipeline and visualization tools are available in the project
repository: \texttt{project\_cda/1\_general\_graph\_metrics.ipynb}.}, we analyze the structural evolution of the
projections derived from the bipartite graph. We first examine the Anime-Anime network to understand how content relationships
shifted over time, followed by an analysis of the User-User network.
...
stabilized at a remarkably high value of $\approx$0.59. This indicates that the "Small-World" property \cite{small_world} is preserved locally.
...
demonstrates a strict linear descent, characteristic of a Scale-Free Network ($P(k) \sim k^{-\gamma}$) \cite{log}.
