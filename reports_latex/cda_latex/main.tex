...
\acmYear{2025}
\begin{document}
\title{Structural Evolution and User Migration in Dynamic Interest Graphs: A Case Study of MyAnimeList (2006–2018)}
...
\input{chapters/data_and_methodology.tex}
\input{chapters/global_topological_evolution.tex}
\input{chapters/clusterization.tex}
\input{chapters/random_walker.tex}
\input{chapters/modeling_of_user_migration.tex}
